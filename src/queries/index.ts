...
export const queries = mergeQueryKeys(profileQueries, categoryQueries, dashboardQueries, cartQueries, wishlistQueries, orderQueries, sellerQueries, reviewQueries, userInfoQueries, adminQueries);
