          ...
          <div className="mx-auto w-full max-w-[calc(1280px+4px*4*2)] px-4 py-8">
            <div className="flex items-center justify-center">
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-2xl font-bold uppercase text-primary">{categoryName ? `${categoryName} ${t('Product.products')}` : t('Product.allProducts')}</h1>
              </div>
            </div>
          </div>
          {categoryName && <p className="mx-auto mt-4 max-w-2xl text-gray-600 dark:text-gray-400">{t('Product.categorySubtitle', { category: categoryName })}</p>}
        </div>
