...
export const ChatWindow = memo(() => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <div className={cn('h-96 w-80 rounded-lg bg-white shadow-2xl', 'flex flex-col border border-gray-200', 'transform transition-all duration-200', 'animate-in slide-in-from-bottom-4')}>
        {/* Header */}
