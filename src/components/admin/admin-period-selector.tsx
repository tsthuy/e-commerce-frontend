...
import type { AdminPeriodType } from '~/types/admin-dashboard';
...
export const AdminPeriodSelector: FC<AdminPeriodSelectorProps> = ({ value, onChange }) => {
  const [isOpen, setIsOpen] = useState(false);
  const currentLabel = periodOptions.find((option) => option.value === value)?.label || '3 Days';
